...
func PlayRound(playerValue int) Round {
	...
	case ROCK:
		computerChoice = "La computadora eligio ROCK"
		break
	case PAPER:
		computerChoice = "La computadora eligio PAPER"
		break
	case SCISSORS:
		computerChoice = "La computadora eligio SCISSORS"
		break
	default:
	}
